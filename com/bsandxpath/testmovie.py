...
#     cursor1.execute(sql, (
#     name, translate_name, year, product_site, classify, actors, title, content, cover_url, screenshot_url, thunder_url,
#     magnet_url))
#     connection.commit()
#     cursor1.close()
#     connection.close()
...
def main():
    base_url = "http://www.dytt8.net/html/gndy/dyzz/list_23_1.html"
